    ...
    <div id="page-register" className="min-h-screen bg-[#f3f4fd] flex items-center justify-center p-4 md:p-8 relative overflow-hidden font-body">
      ...
      <main className="w-full max-w-[940px] bg-white rounded-[28px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.06)] flex flex-col md:flex-row relative z-10 min-h-[600px] border border-slate-100">
        ...
        <div className="w-full md:w-[45%] flex flex-col justify-between text-white relative overflow-hidden select-none"
             style={{background: 'linear-gradient(150deg, #005c27 0%, #006e2f 55%, #008a3c 100%)',
        ...
        <div className="hidden md:block absolute top-0 bottom-0 pointer-events-none" style={{left: 'calc(45% - 40px)', width: '60px', zIndex: 1,
               clipPath: 'polygon(0% 0%, 100% 0%, 60% 50%, 100% 100%, 0% 100%)',
               background: 'rgba(0,100,42,0.30)'}} />
        <div className="hidden md:block absolute top-0 bottom-0 pointer-events-none" style={{left: 'calc(45% - 25px)', width: '55px', zIndex: 0,
        ...
        <div className="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-center bg-white">
          <div className="w-full max-w-[360px] mx-auto">
            ...
            {/* ULSA Logo - right side, natural colors */}
            <div className="mb-4 flex justify-center">
              <img src={ulsaLogo} alt="ULSA Logo" className="w-16 h-16 object-contain" />
            </div>
            ...
            <form id="registerForm" className="space-y-3" onSubmit={handleRegister}>
              ...
              <button id="registerBtn"
                className="w-full bg-[#006e2f] hover:bg-[#005321] disabled:bg-slate-400 disabled:cursor-not-allowed text-white font-headline font-bold py-3 px-4 rounded-xl shadow-lg shadow-green-600/10 active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-3 text-xs"
