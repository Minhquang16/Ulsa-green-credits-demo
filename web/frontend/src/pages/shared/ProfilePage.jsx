...
export default function ProfilePage() {
    ...
    const history = [
        { id: 1, time: "12/06/2026 11:21", title: "Đạp xe xanh", typeDesc: "Sự kiện", category: "Nhận UGC", amount: "+10", status: "Đã duyệt", icon: "directions_bike", iconClass: "profile-history__activity-icon--green", amountClass: "profile-history__amount--positive", statusClass: "profile-history__status--approved" },
        { id: 2, time: "11/06/2026 08:45", title: "Thu gom chai nhựa", typeDesc: "Hoạt động", category: "Nhận UGC", amount: "+15", status: "Đã duyệt", icon: "delete_outline", iconClass: "profile-history__activity-icon--blue", amountClass: "profile-history__amount--positive", statusClass: "profile-history__status--approved" },
        { id: 3, time: "10/06/2026 16:20", title: "Trồng cây gây rừng", typeDesc: "Sự kiện", category: "Nhận UGC", amount: "+20", status: "Đã duyệt", icon: "park", iconClass: "profile-history__activity-icon--green", amountClass: "profile-history__amount--positive", statusClass: "profile-history__status--approved" },
        { id: 4, time: "09/06/2026 14:10", title: "Đổi áo thun ULSA Green", typeDesc: "Đổi quà", category: "Đổi quà", amount: "-80", status: "Thành công", icon: "checkroom", iconClass: "profile-history__activity-icon--blue", amountClass: "profile-history__amount--negative", statusClass: "profile-history__status--success" },
        { id: 5, time: "08/06/2026 09:05", title: "Đổi voucher xe buýt", typeDesc: "Đổi quà", category: "Đổi quà", amount: "-30", status: "Thành công", icon: "confirmation_number", iconClass: "profile-history__activity-icon--red", amountClass: "profile-history__amount--negative", statusClass: "profile-history__status--success" },
    ];
        ...
        <div className="profile-page animate-in fade-in">
                ...
                <div className="profile-page__info-section">
                    ...
                    <div className="profile-page__details">
                        <div className="profile-page__name-row">
                            <h1 className="profile-page__name">{studentInfo.name}</h1>
                    ...
                    <div className="green-id-card">
                        ...
                        <div className="green-id-card__progress-container">
                            <div className="green-id-card__progress-bar">
                                <div className="green-id-card__progress-fill" style={{ width: `${(studentInfo.rankProgress / studentInfo.rankMax) * 100}%` }}></div>
                            </div>
                    ...
                    <div className="profile-wallet">
                        <div className="profile-wallet__left">
                            ...
                            <div className="profile-wallet__address-box">
                                <span className="profile-wallet__address">{studentInfo.walletAddress}</span>
                                <button className="profile-wallet__copy-btn">
                        ...
                        <div className="profile-wallet__right">
                            ...
                            <button className="profile-wallet__history-btn">
            ...
            <div className="profile-page__stats-grid">
                <div className="stat-box stat-box--green">
                    ...
                    <div>
                        <div className="stat-box__value">{studentInfo.totalEarned.toLocaleString()}<span>UGC</span></div>
                        <div className="stat-box__trend stat-box__trend--up"><span className="material-symbols-outlined" style={{fontSize: 14}}>trending_up</span> 120 UGC so với tháng trước</div>
                    </div>
                </div>
                ...
                <div className="stat-box stat-box--blue">
                    ...
                    <div>
                        <div className="stat-box__value">{studentInfo.totalEvents}<span>sự kiện</span></div>
                        <div className="stat-box__trend stat-box__trend--up"><span className="material-symbols-outlined" style={{fontSize: 14}}>trending_up</span> 3 sự kiện so với tháng trước</div>
                    </div>
                </div>
                ...
                <div className="stat-box stat-box--orange">
                    ...
                    <div>
                        <div className="stat-box__value">{studentInfo.longestStreak}<span>ngày</span></div>
                ...
                <div className="stat-box stat-box--purple">
                    ...
                    <div>
                        <div className="stat-box__value">{studentInfo.schoolRank}<span>/ {studentInfo.schoolTotal}</span></div>
                        <div className="stat-box__trend stat-box__trend--neutral">Top 1% sinh viên tích cực</div>
                    </div>
                </div>
            </div>
            ...
            <div className="profile-page__card mb-6">
                ...
                <div className="profile-badges__grid">
                    {badges.map(b => (
                        <div key={b.id} className="profile-badges__item">
                ...
                <div className="profile-badges__progress-grid">
                    {inProgressBadges.map(b => {
                        ...
                        return (
                            <div key={b.id} className="profile-badges__progress-card">
                ...
                <div className="overflow-x-auto">
                    <table className="profile-history__table">
                        ...
                        <tbody>
                            {history.map(row => (
                                <tr key={row.id}>
                                    <td className="profile-history__time">{row.time}</td>
                                    <td>
                                        <div className="profile-history__activity">
                                            <div className={`profile-history__activity-icon ${row.iconClass}`}>
                                                <span className="material-symbols-outlined text-[18px]">{row.icon}</span>
                                            </div>
                                            <div className="profile-history__activity-info">
                                                <h4>{row.title}</h4>
                                                <p>{row.typeDesc}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="profile-history__type">{row.category}</td>
                                    <td className={`profile-history__amount ${row.amountClass}`}>{row.amount}</td>
                                    <td>
                                        <span className={`profile-history__status ${row.statusClass}`}>{row.status}</span>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
