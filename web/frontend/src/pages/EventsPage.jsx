                      ...
                      <div className="rounded-xl bg-surface-container-highest p-3 space-y-2 border border-primary/20">
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-primary">
                            {atEditId ? 'Thay đổi ảnh bìa' : 'Ảnh bìa cho nhiệm vụ'}
                          </label>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[#16a34a] text-lg">check_circle</span>
                    <span className="text-xs font-medium text-slate-700">Đạp xe ít nhất 3 lần</span>
                  </div>
                  <span className="text-xs font-bold text-[#16a34a]">2/3</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[#16a34a] text-lg">check_circle</span>
                  ...
                  <span className="text-xs font-bold text-[#16a34a]">1/1</span>
                </div>
